...
import com.example.dicerollerandroid.ui.theme.DiceRollerAndroidTheme
...
fun DiceRollerScreen( modifier: Modifier = Modifier) {
   Column(modifier = Modifier
       ...
       Image(
           ...
           contentDescription = randomNumber.toString()
       )
       Spacer(modifier = Modifier.height(16.dp))
       Button(onClick = handleClickRoll ) {
